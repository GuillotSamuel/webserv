...
/*   Updated: 2024/09/01 21:28:07 by sguillot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "webserv.hpp"

void ServerConfiguration::ft_set_tokens(std::vector<std::string> tokens)
{
	if (!tokens.empty())
	{
...
void	ServerConfiguration::ft_start_set_tokens(std::vector<std::string> tokens)
{
...
void	ServerConfiguration::ft_invalid_line(std::vector<std::string> tokens)
{
...
void	ServerConfiguration::ft_param_set_tokens(std::vector<std::string> tokens)
{
    ...
    bool (*param_functions[nb_param])(const std::vector<std::string>) = {
        &ft_set_listen_param,
