...
/*   Updated: 2024/09/01 21:37:23 by sguillot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ServerConfiguration::ft_set_host_name_param(std::vector<std::string> tokens)
{
    if (tokens.size() != 2)
    {
    ...
    this->hostName = (tokens[1].substr(0, tokens[1].size() - 1));
}
