...
/*   Updated: 2024/09/30 21:28:01 by sguillot         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string Response::autoIndex()
{
	...
	html << "h1 {font-size: 1rem; margin-bottom: 20px; text-transform: uppercase; letter-spacing: 2px; color: #fefefe; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.7);}\n";
